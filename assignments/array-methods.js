...
// Problem 1: Need to show all runner's emails to send an update.
let runnerEmail = [];
runners.forEach(runner => runnerEmail.push(runner.email));
console.log(runnerEmail);

// Problem 2: Need to order shirts. Show name and shirt size.
let shirtOrder = [];
